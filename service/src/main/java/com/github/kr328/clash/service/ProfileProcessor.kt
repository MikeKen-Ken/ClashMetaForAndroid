            ...
            processLock.withLock {
                ...
                profileLock.withLock {
                    if (PendingDao().queryByUUID(snapshot.uuid) == snapshot) {
                        ...
                        val metadataOnlyFallback = fetchException != null && snapshot.type == Profile.Type.Url && old != null

                        if (fetchException != null && !metadataOnlyFallback) {
                            throw fetchException as Exception
                        }

                        if (!metadataOnlyFallback) {
                        ...
                        var total: Long = 0
                        var expire: Long = 0
                        if (metadataOnlyFallback && old != null) {
                            upload = old.upload
                        ...
                        if (snapshot?.type == Profile.Type.Url) {
                            if (!metadataOnlyFallback && snapshot.source.startsWith("https://", true)) {
