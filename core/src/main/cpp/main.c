...
JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeSetHealthCheckWorkerLimit(JNIEnv *env, jobject thiz,
                                                                             jint limit) {
    TRACE_METHOD();

    setHealthCheckWorkerLimit((int) limit);
}
...
JNIEXPORT jboolean JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativePatchRuntimeLogLevel(JNIEnv *env, jobject thiz,
                                                                         jstring level) {
    TRACE_METHOD();

    scoped_string _level = get_string(level);

    return (jboolean) patchRuntimeLogLevel(_level);
}

JNIEXPORT jboolean JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativePatchConnectivityJson(JNIEnv *env, jobject thiz,
                                                                            jstring jsonPayload) {
    TRACE_METHOD();

    scoped_string _json = get_string(jsonPayload);

    return (jboolean) patchConnectivityJson(_json);
}
...
JNIEXPORT jstring JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeQueryRuntimeYamlByProfile(JNIEnv *env, jobject thiz,
                                                                                jstring profile_path) {
    TRACE_METHOD();

    scoped_string _profile_path = get_string(profile_path);
    scoped_string response = queryRuntimeYamlByProfile(_profile_path);
...
Java_com_github_kr328_clash_core_bridge_Bridge_nativeCloseAllConnections(JNIEnv *env, jobject thiz) {
    ...
    closeAllConnectionsExported();
}

JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeCloseConnectionsExcludingDirect(JNIEnv *env,
                                                                                    jobject thiz) {
    TRACE_METHOD();
...
JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeCloseConnectionsUsingProxyGroup(JNIEnv *env,
                                                                                     jobject thiz,
                                                                                     jstring group) {
    TRACE_METHOD();
    ...
    closeConnectionsUsingProxyGroupExported(_group);
}

JNIEXPORT void JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeCloseLanConnections(JNIEnv *env, jobject thiz) {
    TRACE_METHOD();
...
JNIEXPORT jstring JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeExportProxyConnectivityStats(JNIEnv *env, jobject thiz) {
    TRACE_METHOD();

    scoped_string response = exportProxyConnectivityStats();
    return new_string(response);
}

JNIEXPORT jboolean JNICALL
Java_com_github_kr328_clash_core_bridge_Bridge_nativeReplaceProxyConnectivityStats(JNIEnv *env, jobject thiz,
                                                                                   jstring raw) {
    TRACE_METHOD();

    scoped_string _raw = get_string(raw);
...
static jmethodID m_health_check_callback_on_triggered;
